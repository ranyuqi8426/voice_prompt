...
public class SysLog {
	...
	public String toString() {
		return "SysLog [id=" + id + ", user_id=" + user_id + ", opera_date=" + opera_date + ", opera_ip=" + opera_ip
				+ ", module_name=" + module_name + ", opera_name=" + opera_name + ", opera_url=" + opera_url
				+ ", opera_type=" + opera_type + ", opera_params=" + opera_params + ", realname=" + realname
				+ ", username=" + username + "]";
	}
